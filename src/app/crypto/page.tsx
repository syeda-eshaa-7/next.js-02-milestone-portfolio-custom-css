      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <p>
            ...
            using Firebase. Users can create a new account using their
            ...
            application is dynamic routing through the GitHub: Sign In(React Router DOM)
            package. This application was built using the Coin Gecko API.
          </p>
          {/* Removed <a> tags, replaced with simple buttons */}
          <button className='px-8 py-2 mt-4 mr-8 bg-blue-500 text-white rounded'>
            Code (GitHub)
          </button>
          <button className='px-8 py-2 mt-4 bg-blue-500 text-white rounded'>
            Demo
          </button>
        </div>
